...
NS_LOG_COMPONENT_DEFINE ("AdhocWifiMacJason");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (AdhocWifiMacJason);

TypeId
AdhocWifiMacJason::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::AdhocWifiMacJason")
    .SetParent<RegularWifiMac> ()
    .AddConstructor<AdhocWifiMacJason> ()
  ;
  return tid;
}

AdhocWifiMacJason::AdhocWifiMacJason ()
{
...
void
AdhocWifiMacJason::SetAddress (Mac48Address address)
{
...
void
AdhocWifiMacJason::Enqueue (Ptr<const Packet> packet, Mac48Address to)
{
...
void
AdhocWifiMacJason::SetLinkUpCallback (Callback<void> linkUp)
{
...
void
AdhocWifiMacJason::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr)
{
